...
public class UBlocks {
    ...
    public static final Block NETHER_ILLAGER_ORE = register(new Identifier(UAdd.MOD_ID, "nether_illager_ore"), createNetherOre(), new FabricItemSettings());
    public static final Block END_ILLAGER_ORE = register(new Identifier(UAdd.MOD_ID, "end_illager_ore"), createEndOre(), new FabricItemSettings());
