...
public class UBlocks {
    ...
    public static final Pipe DIAMOND_PIPE = register(new Identifier(UAdd.MOD_ID, "diamond_pipe"), new Pipe(FabricBlockSettings.create().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().notSolid(), 2.25f), new FabricItemSettings());
