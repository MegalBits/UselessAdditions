...
public class ScytheItem extends MiningToolItem implements Vanishable, TwoHanded {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if (UItemHelper.getEffects(stack) != effects) UItemHelper.addEffects(stack, effects);
