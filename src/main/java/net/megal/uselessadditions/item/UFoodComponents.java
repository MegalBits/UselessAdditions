...
public class UFoodComponents {
    ...
    public static final FoodComponent FROG_LEG_STEW = new FoodComponent.Builder().hunger(8).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 200, 0), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 200, 1), 0.5f).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 300, 1), 0.2f).alwaysEdible().build();
