...
public class WitherEnchantment extends AugmentEnchantment {
    ...
    public void onTargetDamaged(LivingEntity user, Entity target, int level) {
        if (target instanceof LivingEntity) ((LivingEntity) target).addStatusEffect(new StatusEffectInstance(StatusEffects.WITHER, getStatusDuration(level), 0));
    }
    @Override
    ...
    public @Nullable UnaryOperator<Style> getColor() {
        return style -> style.withColor(7561558);
    }
}
