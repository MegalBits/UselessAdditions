...
public class UWorldgen {
    ...
    public static final RegistryKey<PlacedFeature> BLAZE_ORE = register(new Identifier(UAdd.MOD_ID,"blaze_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> ENDERMAN_ORE = register(new Identifier(UAdd.MOD_ID,"enderman_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    public static final RegistryKey<PlacedFeature> ENDERMITE_ORE = register(new Identifier(UAdd.MOD_ID,"endermite_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> GHAST_ORE = register(new Identifier(UAdd.MOD_ID,"ghast_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> HOGLIN_ORE = register(new Identifier(UAdd.MOD_ID,"hoglin_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> MAGMA_CUBE_ORE = register(new Identifier(UAdd.MOD_ID,"magma_cube_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> PIGLIN_ORE = register(new Identifier(UAdd.MOD_ID,"piglin_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> SHULKER_ORE = register(new Identifier(UAdd.MOD_ID,"shulker_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> STRIDER_ORE = register(new Identifier(UAdd.MOD_ID,"strider_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
    ...
    public static final RegistryKey<PlacedFeature> WITHER_SKELETON_ORE = register(new Identifier(UAdd.MOD_ID,"wither_skeleton_ore"), BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES);
